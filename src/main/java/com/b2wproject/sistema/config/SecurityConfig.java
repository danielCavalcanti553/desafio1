...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	// URL liberadas (Teste)
	private static final String[] PUBLIC_MATCHERS = { "/planetas/**" };

	// URL GET Liberadas sem login
	private static final String[] PUBLIC_MATCHERS_GET = { "/planetas/**" };

	// URL POST Liberadas sem login
	private static final String[] PUBLIC_MATCHERS_POST = { "/planetas/**" };
